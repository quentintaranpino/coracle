  ...
  <Content>
    ...
    <div class="flex w-full flex-col gap-8">
      ...
      <Field label="Upload Providers URL">
        <p slot="info">
          Enter a custom url for {appName}'s upload provider server. You can find a full list of
      ...
      <Field label="Publish media as NIP94">
        ...
        <p slot="info">Use NIP94 events instead regular URL links for every uploaded media file.</p>
      </Field>
